...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvJVCLUtils.pas 11971 2008-10-18 11:52:10Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_36_PREPARATION/run/JvJVCLUtils.pas $';
    Revision: '$Revision: 11971 $';
    Date: '$Date: 2008-10-18 13:52:10 +0200 (sam., 18 oct. 2008) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
