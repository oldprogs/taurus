...
Version 2.63	-> Also update OutputFileHeader when changing the version #
...
var
	...
	UnitsCount: integer;
	OutputFileHeader: string = 'MemCheck version 2.63'#13#10;
...
begin
	{$IFDEF DELPHI6_OR_LATER}
	if ltgmCallerIsNewAnsiString
		{$IFDEF DELPHI7_OR_LATER}
		or CallerIsDynamicArrayAllocation
		{$ENDIF}
	then
	{$ELSE}
