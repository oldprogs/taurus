...
function lineGetNumRings(
    hLine : HLINE;
    dwAddressID : DWORD;
    lpdwNumRings : LPDWORD) : LONG; stdcall;
...
function TapiCheck (ResultCode : DWORD): string;
...
Begin
  Result := '';
  if integer(ResultCode) < 0 Then
    Begin
    case (ResultCode) of
         LINEERR_ALLOCATED: strError := 'TAPI Line: LINEERR_ALLOCATED';
         LINEERR_BADDEVICEID: strError := 'TAPI Line: LINEERR_BADDEVICEID';
         LINEERR_BEARERMODEUNAVAIL: strError := 'TAPI Line: LINEERR_BEARERMODEUNAVAIL';
         LINEERR_CALLUNAVAIL: strError := 'TAPI Line: LINEERR_CALLUNAVAIL';
         LINEERR_COMPLETIONOVERRUN: strError := 'TAPI Line: LINEERR_COMPLETIONOVERRUN';
         LINEERR_CONFERENCEFULL: strError := 'TAPI Line: LINEERR_CONFERENCEFULL';
         LINEERR_DIALBILLING: strError := 'TAPI Line: LINEERR_DIALBILLING';
         LINEERR_DIALDIALTONE: strError := 'TAPI Line: LINEERR_DIALDIALTONE';
         LINEERR_DIALPROMPT: strError := 'TAPI Line: LINEERR_DIALPROMPT';
         LINEERR_DIALQUIET: strError := 'TAPI Line: LINEERR_DIALQUIET';
         LINEERR_INCOMPATIBLEAPIVERSION: strError := 'TAPI Line: LINEERR_INCOMPATIBLEAPIVERSION';
         LINEERR_INCOMPATIBLEEXTVERSION: strError := 'TAPI Line: LINEERR_INCOMPATIBLEEXTVERSION';
         LINEERR_INIFILECORRUPT: strError := 'TAPI Line: LINEERR_INCOMPATIBLEEXTVERSION';
         LINEERR_INUSE: strError := 'TAPI Line: LINEERR_INUSE';
         LINEERR_INVALADDRESS: strError := 'TAPI Line: LINEERR_INVALADDRESS';
         LINEERR_INVALADDRESSID: strError := 'TAPI Line: LINEERR_INVALADDRESSID';
         LINEERR_INVALADDRESSMODE: strError := 'TAPI Line: LINEERR_INVALADDRESSMODE';
         LINEERR_INVALADDRESSSTATE: strError := 'TAPI Line: LINEERR_INVALADDRESSSTATE';
         LINEERR_INVALAPPHANDLE: strError := 'TAPI Line: LINEERR_INVALAPPHANDLE';
         LINEERR_INVALAPPNAME: strError := 'TAPI Line: LINEERR_INVALAPPNAME';
         LINEERR_INVALBEARERMODE: strError := 'TAPI Line: LINEERR_INVALBEARERMODE';
         LINEERR_INVALCALLCOMPLMODE: strError := 'TAPI Line: LINEERR_INVALCALLCOMPLMODE';
         LINEERR_INVALCALLHANDLE: strError := 'TAPI Line: LINEERR_INVALCALLHANDLE';
         LINEERR_INVALCALLPARAMS: strError := 'TAPI Line: LINEERR_INVALCALLPARAMS';
         LINEERR_INVALCALLPRIVILEGE: strError := 'TAPI Line: LINEERR_INVALCALLPRIVILEGE';
         LINEERR_INVALCALLSELECT: strError := 'TAPI Line: LINEERR_INVALCALLSELECT';
         LINEERR_INVALCALLSTATE: strError := 'TAPI Line: LINEERR_INVALCALLSTATE';
         LINEERR_INVALCALLSTATELIST: strError := 'TAPI Line: LINEERR_INVALCALLSTATELIST';
         LINEERR_INVALCARD: strError := 'TAPI Line: LINEERR_INVALCARD';
         LINEERR_INVALCOMPLETIONID: strError := 'TAPI Line: LINEERR_INVALCOMPLETIONID';
         LINEERR_INVALCONFCALLHANDLE: strError := 'TAPI Line: LINEERR_INVALCOMPLETIONID';
         LINEERR_INVALCONSULTCALLHANDLE: strError := 'TAPI Line: LINEERR_INVALCONSULTCALLHANDLE';
         LINEERR_INVALCOUNTRYCODE: strError := 'TAPI Line: LINEERR_INVALCOUNTRYCODE';
         LINEERR_INVALDEVICECLASS: strError := 'TAPI Line: LINEERR_INVALDEVICECLASS';
         LINEERR_INVALDEVICEHANDLE: strError := 'TAPI Line: LINEERR_INVALDEVICEHANDLE';
         LINEERR_INVALDIALPARAMS: strError := 'TAPI Line: LINEERR_INVALDIALPARAMS';
         LINEERR_INVALDIGITLIST: strError := 'TAPI Line: LINEERR_INVALDIGITLIST';
         LINEERR_INVALDIGITMODE: strError := 'TAPI Line: LINEERR_INVALDIGITMODE';
         LINEERR_INVALDIGITS: strError := 'TAPI Line: LINEERR_INVALDIGITS';
         LINEERR_INVALEXTVERSION: strError := 'TAPI Line: LINEERR_INVALEXTVERSION';
         LINEERR_INVALGROUPID: strError := 'TAPI Line: LINEERR_INVALGROUPID';
         LINEERR_INVALLINEHANDLE: strError := 'TAPI Line: LINEERR_INVALLINEHANDLE';
         LINEERR_INVALLINESTATE: strError := 'TAPI Line: LINEERR_INVALLINESTATE';
         LINEERR_INVALLOCATION: strError := 'TAPI Line: LINEERR_INVALLOCATION';
         LINEERR_INVALMEDIALIST: strError := 'TAPI Line: LINEERR_INVALMEDIALIST';
         LINEERR_INVALMEDIAMODE: strError := 'TAPI Line: LINEERR_INVALMEDIAMODE';
         LINEERR_INVALMESSAGEID: strError := 'TAPI Line: LINEERR_INVALMESSAGEID';
         LINEERR_INVALPARAM: strError := 'TAPI Line: LINEERR_INVALPARAM';
         LINEERR_INVALPARKID: strError := 'TAPI Line: LINEERR_INVALPARKID';
         LINEERR_INVALPARKMODE: strError := 'TAPI Line: LINEERR_INVALPARKMODE';
         LINEERR_INVALPOINTER: strError := 'TAPI Line: LINEERR_INVALPOINTER';
         LINEERR_INVALPRIVSELECT: strError := 'TAPI Line: LINEERR_INVALPRIVSELECT';
         LINEERR_INVALRATE: strError := 'TAPI Line: LINEERR_INVALRATE';
         LINEERR_INVALREQUESTMODE: strError := 'TAPI Line: LINEERR_INVALREQUESTMODE';
         LINEERR_INVALTERMINALID: strError := 'TAPI Line: LINEERR_INVALREQUESTMODE';
         LINEERR_INVALTERMINALMODE: strError := 'TAPI Line: LINEERR_INVALTERMINALMODE';
         LINEERR_INVALTIMEOUT: strError := 'TAPI Line: LINEERR_INVALTIMEOUT';
         LINEERR_INVALTONE: strError := 'TAPI Line: LINEERR_INVALTONE';
         LINEERR_INVALTONELIST: strError := 'TAPI Line: LINEERR_INVALTONELIST';
         LINEERR_INVALTONEMODE: strError := 'TAPI Line: LINEERR_INVALTONEMODE';
         LINEERR_INVALTRANSFERMODE: strError := 'TAPI Line: LINEERR_INVALTRANSFERMODE';
         LINEERR_LINEMAPPERFAILED: strError := 'TAPI Line: LINEERR_LINEMAPPERFAILED';
         LINEERR_NOCONFERENCE: strError := 'TAPI Line: LINEERR_NOCONFERENCE';
         LINEERR_NODEVICE: strError := 'TAPI Line: LINEERR_NODEVICE';
         LINEERR_NODRIVER: strError := 'TAPI Line: LINEERR_NODRIVER';
         LINEERR_NOMEM: strError := 'TAPI Line: LINEERR_NOMEM';
         LINEERR_NOREQUEST: strError := 'TAPI Line: LINEERR_NOREQUEST';
         LINEERR_NOTOWNER: strError := 'TAPI Line: LINEERR_NOTOWNER';
         LINEERR_NOTREGISTERED: strError := 'TAPI Line: LINEERR_NOTREGISTERED';
         LINEERR_OPERATIONFAILED: strError := 'TAPI Line: LINEERR_OPERATIONFAILED';
         LINEERR_OPERATIONUNAVAIL: strError := 'TAPI Line: LINEERR_OPERATIONUNAVAIL';
         LINEERR_RATEUNAVAIL: strError := 'TAPI Line: LINEERR_RATEUNAVAIL';
         LINEERR_RESOURCEUNAVAIL: strError := 'TAPI Line: LINEERR_RESOURCEUNAVAIL';
         LINEERR_REQUESTOVERRUN: strError := 'TAPI Line: LINEERR_REQUESTOVERRUN';
         LINEERR_STRUCTURETOOSMALL: strError := 'TAPI Line: LINEERR_STRUCTURETOOSMALL';
         LINEERR_TARGETNOTFOUND: strError := 'TAPI Line: LINEERR_TARGETNOTFOUND';
         LINEERR_TARGETSELF: strError := 'TAPI Line: LINEERR_TARGETSELF';
         LINEERR_UNINITIALIZED: strError := 'TAPI Line: LINEERR_UNINITIALIZED';
         LINEERR_USERUSERINFOTOOBIG: strError := 'TAPI Line: LINEERR_USERUSERINFOTOOBIG';
         LINEERR_REINIT: strError := 'TAPI Line: LINEERR_REINIT';
         LINEERR_ADDRESSBLOCKED: strError := 'TAPI Line: LINEERR_ADDRESSBLOCKED';
         LINEERR_BILLINGREJECTED: strError := 'TAPI Line: LINEERR_BILLINGREJECTED';
         LINEERR_INVALFEATURE: strError := 'TAPI Line: LINEERR_INVALFEATURE';
         LINEERR_NOMULTIPLEINSTANCE: strError := 'TAPI Line: LINEERR_NOMULTIPLEINSTANCE';
{$IFDEF Tapi_Ver20}
         LINEERR_INVALAGENTID: strError := 'TAPI Line: LINEERR_INVALAGENTID';
         LINEERR_INVALAGENTGROUP: strError := 'TAPI Line: LINEERR_INVALAGENTGROUP';
         LINEERR_INVALPASSWORD: strError := 'TAPI Line: LINEERR_INVALPASSWORD';
         LINEERR_INVALAGENTSTATE: strError := 'TAPI Line: LINEERR_INVALAGENTSTATE';
         LINEERR_INVALAGENTACTIVITY: strError := 'TAPI Line: LINEERR_INVALAGENTACTIVITY';
         LINEERR_DIALVOICEDETECT: strError := 'TAPI Line: LINEERR_DIALVOICEDETECT';
{$ENDIF}
    else
...
{    else
       raise Exception.Create(strError+#13+#10+
                           'You are running under Windows 95 - shutdown is recomended.');}
//       thisTAPILine.InfoLabel.Text := ' strError '
    End;
End;
