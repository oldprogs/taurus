...
procedure BuildNodeWizzardColl(FColl: TNodeWizzardColl; ABuildStrings: Boolean; addr: string = '');
...
begin
  ...
  IPData.InPorts.Fill(['60179', '23 60177', '24554', '21', '80', '25', '110', '60180', '119']);
  IPData.StationData.Fill(['Taurus IP Server',
    '1:2/3.4 5:6/7.8',
    'Joe Sysop',
    'Universe, Earth',
    '127.0.0.1',
...
begin
  ...
  if ((o = LangNames[lnRussian]) and RussianHelp) or
     ((o = LangNames[lnEnglish]) and EnglishHelp) then l := o else
  begin
    if EnglishHelp then l := LangNames[lnEnglish] else
    if RussianHelp then l := LangNames[lnRussian] else l := '';
